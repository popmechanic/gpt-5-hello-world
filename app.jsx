    ...
    <div className="min-h-screen text-[#242424]" style={bgPattern}>
      ...
      <header className="max-w-6xl mx-auto px-4 pt-6 pb-2">
        ...
        <p className="mt-3 italic bg-[#ffffff] inline-block px-3 py-2 border-4 border-[#242424]">
          Capture ideas, attach files, and turn prompts into structured cards. Use the generator to create batches, tap any card to edit, and try the image studio to visualize concepts. Drag files onto forms to attach them. Everything saves instantly in your browser.
        </p>
      </header>
